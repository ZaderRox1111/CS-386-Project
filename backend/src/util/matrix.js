...
//Need additional code for exporting these classes/methods
...
class ComplexMatrix extends AbstractMatrix { //Methods will be adapted for Complex once RealMatrix is finished
	constructor(rows,cols) {
...
let a=new RealMatrix(2,2);
a.set(0,0,0);
a.set(1,0,2);
a.set(0,1,1);
a.set(1,1,2);
console.log(a.toString());
console.log(a.ref().toString());
