...
2. As a developer, I want to develop an easy to use calacultor that has a very simple and understandable UI so that user can dont have trouble or any issues using our calculator(priority #1, about 10 hours)
