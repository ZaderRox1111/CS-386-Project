...
Jacob's stories:
   1. As a user who is a Statistics major, I want to have easy-use calculator for many probability calculations, to reduce scratch work on more complicated statistics problems.
   2. As a user who is a non-STEM major, I want to have a calculator that can show me how certain calculations are performed, with detailed descriptions of each step.
